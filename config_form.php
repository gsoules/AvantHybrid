...
<div class="field">
    <div class="two columns alpha">
        <label><?php echo CONFIG_LABEL_HYBRID_SYNC_PW; ?></label>
    </div>
    <div class="inputs five columns omega">
        <p class="explanation"><?php echo __("The synchronization password (8 alphanumeric characters)"); ?></p>
        <?php echo $view->formText(HybridConfig::OPTION_HYBRID_SYNC_PW, $syncPw); ?>
    </div>
</div>
